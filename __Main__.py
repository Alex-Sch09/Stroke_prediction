...
if st.session_state.section == 'Plan':
    ...
    st.markdown(Text2)
    st.image('C:/Users/Alex/Desktop/Proyecto_final/Stroke_prediction/Images/Age-Stroke.png')  
    st.markdown(Text3)
    st.image('C:/Users/Alex/Desktop/Proyecto_final/Stroke_prediction/Images/Glucose-Stroke.png')
    st.markdown(Text4)  
    st.image('C:/Users/Alex/Desktop/Proyecto_final/Stroke_prediction/Images/Age-Glucose.png')
    st.markdown(Text5)  
    st.image('C:/Users/Alex/Desktop/Proyecto_final/Stroke_prediction/Images/Cramers-V.png')
    st.markdown(Text6)
