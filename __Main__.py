...
if st.session_state.section == 'Plan':
    ...
    st.markdown(Text2)
    st.image('Stroke_prediction/Images/Age-Stroke.png')  
    st.markdown(Text3)
    st.image('Stroke_prediction/Images/Glucose-Stroke.png')
    st.markdown(Text4)  
    st.image('Stroke_prediction/Images/Age-Glucose.png')
    st.markdown(Text5)  
    st.image('Stroke_prediction/Images/Cramers-V.png')
    st.markdown(Text6)
